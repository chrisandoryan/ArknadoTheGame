...
DialogModalPlugin.prototype = {
    ...
    init: function (opts) {
        ...
        this.text;
        // the current line number in the window
        this.lineNumber = 1;
    ...
    _setText: function (text) {
        ...
        var y = this._getGameHeight() - this.windowHeight - this.padding + ( 10 * this.lineNumber );

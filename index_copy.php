...
<script>
	...
	async function login(dialogModal) {
		dialogModal.init();
		...
		request('/user/login', {username: uname, password: passwd})
			.done((e) => {
	...
	async function register(dialogModal) {
		dialogModal.init();
		...
		request('/user/register', {username: uname, email: email, password: passwd})
			.done((e) => {
	...
	function create() {
		...
		loginButton.setInteractive()
			.on('pointerdown', () => {
				login(this.sys.DialogModalPlugin);
		...
		regisButton.setInteractive()
			.on('pointerdown', () => {
				register(this.sys.DialogModalPlugin);
			})
			.on('pointerover', () => {
